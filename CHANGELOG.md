...
* [#1361](https://github.com/mozilla/glean.js/pull/1361): BUGFIX: Guarantee that custom uploaders will timeout even if they do not implement a timeout mechanism.
