 ...
 */
async function getStartTimeMetricAndData(ping: CommonPingData): Promise<StartTimeMetricData> {
 ...
 */
export async function getStartEndTimes(
  ping: CommonPingData
 ...
 */
export async function buildPingInfoSection(
  ping: CommonPingData,
  reason?: string
): Promise<PingInfo> {
 ...
 */
export async function collectAndStorePing(
  identifier: string,
  ping: CommonPingData,
  reason?: string
): Promise<void> {
