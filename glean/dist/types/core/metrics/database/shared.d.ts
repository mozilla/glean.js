...
export declare const METRICS_DATABASE_LOG_TAG = "core.Metrics.Database";
/**
...
export interface IMetricsDatabase {
     ...
     */
    transform(metric: MetricType, transformFn: (v?: JSONValue) => Metric<JSONValue, JSONValue>): OptionalAsync<void>;
    /**
     ...
     */
    hasMetric(lifetime: Lifetime, ping: string, metricType: string, metricIdentifier: string): OptionalAsync<boolean>;
    /**
     ...
     */
    countByBaseIdentifier(lifetime: Lifetime, ping: string, metricType: string, metricIdentifier: string): OptionalAsync<number>;
    /**
...
export declare const RESERVED_METRIC_IDENTIFIER_PREFIX: string;
/**
 ...
 */
export declare function generateReservedMetricIdentifiers(name: string): {
    category: string;
    name: string;
};
/**
 ...
 */
export declare function createMetricsPayload(v: Metrics): Metrics;
