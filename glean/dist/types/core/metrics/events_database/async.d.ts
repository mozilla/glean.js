...
declare class EventsDatabase {
    private eventsStore;
    private initialized;
    constructor();
    initialize(): Promise<void>;
    record(metric: EventMetricType, value: RecordedEvent): Promise<void>;
    getEvents(ping: string, metric: EventMetricType): Promise<Event[] | undefined>;
    getPingEvents(ping: string, clearPingLifetimeData: boolean): Promise<JSONArray | undefined>;
