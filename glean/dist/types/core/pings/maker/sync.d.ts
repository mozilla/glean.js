 ...
 */
export declare function getSequenceNumber(ping: CommonPingData): number;
/**
 ...
 */
export declare function getStartEndTimes(ping: CommonPingData): {
    startTime: string;
    endTime: string;
};
/**
 ...
 */
export declare function buildPingInfoSection(ping: CommonPingData, reason?: string): PingInfo;
/**
 ...
 */
export declare function buildClientInfoSection(ping: CommonPingData): ClientInfo;
/**
 ...
 */
export declare function collectPing(ping: CommonPingData, reason?: string): PingPayload | undefined;
/**
 ...
 * @param reason An optional reason code to include in the ping.
 */
export declare function collectAndStorePing(identifier: string, ping: CommonPingData, reason?: string): void;
