...
declare class PingsDatabase implements IPingDatabase {
    private store;
    private observer?;
    constructor();
    attachObserver(observer: Observer): void;
    recordPing(path: string, identifier: string, payload: JSONObject, headers?: Record<string, string>): Promise<void>;
    deletePing(identifier: string): Promise<void>;
    getAllPings(): Promise<PingArray>;
    scanPendingPings(): Promise<void>;
