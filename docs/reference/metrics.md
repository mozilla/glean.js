...
| glean.restarted |[event](https://mozilla.github.io/glean/book/user/metrics/event.html) |Event that signals an application restart.  **This event is included in all pings (custom or otherwise) that contain events.**  |[Review 1](TODO)||never |1 |
